...
|---|---|---|---|---|---|
| `proposal-wanteeed.html` (EN) / `proposal-wanteeed-fr.html` (FR) | **Wanteeed** — Head of Marketing search (cashback company, Bordeaux) | Live on `main` | 2026-07-30 | `dev-metodas.a-rosales.workers.dev/proposal-wanteeed` (+ `-fr`) | `metodas.co/proposal-wanteeed` (+ `-fr`) |
